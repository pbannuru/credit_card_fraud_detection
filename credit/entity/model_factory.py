...
MetricInfoArtifact = namedtuple("MetricInfoArtifact",
                                ["model_name", "model_object", "train_roc", "test_roc", "train_accuracy",
...
def evaluate_classification_model(model_list: list, X_train:np.ndarray, y_train:np.ndarray, X_test:np.ndarray, y_test:np.ndarray, base_accuracy:float=0.6)->MetricInfoArtifact:
    ...
    try:
        ...
        for model in model_list:
            ...
            #Calculating roc auc score on training and testing dataset
            ...
            logging.info(f"Train roc auc score: [{train_roc}].")
            logging.info(f"Test roc auc score: [{test_roc}].")
